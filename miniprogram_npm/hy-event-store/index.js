...
__DEFINE__(1642642594660, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1642642594661,"./event-store":1642642594662}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642642594661, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1642642594662, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1642642594661,"./utils":1642642594663}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642642594663, function(require, module, exports) {
...
return __REQUIRE__(1642642594660);
})()
